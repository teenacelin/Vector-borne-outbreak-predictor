...
def train_model():
    ...
    # Time-series split. Data spans Nov 2024 to Dec 2025. We use Oct 2025 as cutoff.
    ...
    if train.empty or test.empty:
        raise ValueError("Time-series split failed: train or test set is empty. Check data availability and cutoff date.")
