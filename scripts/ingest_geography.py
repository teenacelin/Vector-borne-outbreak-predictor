...
def ingest():
    ...
    for _, row in gdf.iterrows():
        ...
        cursor.execute('''
            INSERT INTO locations (country, state_name, municipality, ibge_code, latitude, longitude, geometry)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        ''', (country, state_name, municipality, ibge_code, lat, lon, geom_json))
        inserted += 1
